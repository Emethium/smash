        ...
        <b-row>
            <b-col md="6" class="mx-auto">
                <b-card>
                    ...
                    <div slot="footer">
                        <b-button v-on:click="updateData()" type="submit" size="sm" variant="primary"><i class="fa fa-dot-circle-o"></i> Alterar tipo!</b-button>
...
export default {
  ...
  created () {
    ...
    axios.get(`http://localhost:3000/api/v1/service_types/${id}`).then(
      response => {
        this.loading = true
  ...
  methods: {
    ...
    updateData () {
      const id = this.$route.params.id
      axios.patch(`http://localhost:3000/api/v1/service_types/${id}`, {
        kind: this.kind
